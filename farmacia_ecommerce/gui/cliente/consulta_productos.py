...
class ConsultaProductos:
    ...
    def __init__(self, root, user_info):
        ...
        self.search_entry.bind("<KeyRelease>", self._on_search) # Evento al soltar una tecla

        # --- Tabla ---
        table_frame = ttk.Frame(main_frame)
        table_frame.pack(expand=True, fill=tk.BOTH, pady=10)

        self.tree = ttk.Treeview(table_frame, columns=("Nombre", "Descripción", "Precio", "Stock"), show="headings")
    ...
    def _cargar_productos(self, search_term=""):
        ...
        if not productos:
            ...
            self.tree.insert("", tk.END, values=("No se encontraron productos", "", "", ""), tags=('empty',))
        ...
        for prod in productos:
            ...
            self.tree.insert("", tk.END, values=(nombre, desc, formatted_precio, stock_disponible))
